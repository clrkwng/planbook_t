...
<header>
    <div class="container" id="maincontent" tabindex="-1">
        <div class="row">
            <div class="col-lg-12">
                <img class="img-responsive" src="img/profile.png" alt="" height = "300" width = "300">
                <div class="intro-text">
                    <h1 class="name">Planbook</h1>
                    <hr class="star-light">
                    <span class="skills">"To achieve big things, start small"</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2>Activities</h2>
                <!--Can put up different activities for the youth-->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-lg-offset-2">
                <p>Planbook is a free online resource to help people of all ages to keep their lives organized and make the most use of their time.</p>
            </div>
            <div class="col-lg-4">
                <p>Whether you're a student looking to improve your efficiency, a professional looking to maintain a busy schedule, or a parent looking to keep track of family events, this is the perfect tool!</p>
            </div>
        </div>
    </div>
</section>
